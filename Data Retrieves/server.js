...
app.get("/movies", async (req, res) => {
  let storedMovieData = await movie.find();
  res.json(storedMovieData);
});
...
let playerSchema = new mongoose.Schema({
  ...
  teamName: {
    type: String,
    enum: ["csk", "rcb", "kkr", "kxip", "rr", "srh", "lsg", "gt", "dd", "mi"],
    lowercase: true,
  },
...
let getDataFromDB = async () => {
  ...
  let storedMovieDataFromDB = await movie.find();
  console.log(storedMovieDataFromDB);
};
